...
class TestFileProcessor:
    ...
    def test_detect_file_type_with_path(self):
        ...
        assert file_processor.detect_file_type("C:\\Users\\test\\documents\\file.xlsx") == FileType.EXCEL
        assert file_processor.detect_file_type("../statements/bank_statement.pdf") == FileType.PDF
