...
from src.app.schemas import ColumnMapping, FileUploadResponse, Transaction
...
from src.app.services.file_processing.upload_file_service import UploadFileService, UploadFileSpec
...
class TestUploadFileService:
    ...
    def test_upload_file_with_duplicate_transactions(self):
        ...
        transactions_repository = MagicMock()
        transactions_repository.find_duplicates.return_value = [transactions[0]]  # First transaction is a duplicate
