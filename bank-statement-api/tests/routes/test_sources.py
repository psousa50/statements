...
def test_create_source():
    ...
    app_instance = create_app(
        db_session=db_session, sources_repository=sources_repository
    )
    ...
    response = client.post(
        "/sources", json={"name": source.name, "description": source.description}
    )
...
def test_create_source_if_exists():
    ...
    response = client.post(
        "/sources", json={"name": source.name, "description": "New description"}
    )
