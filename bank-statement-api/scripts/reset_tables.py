    ...
    with engine.connect() as conn:
        ...
        if 'transactions' in existing_tables:
            ...
            if 'statement_id' in columns:
                ...
                conn.execute(text("ALTER TABLE transactions DROP COLUMN IF EXISTS statement_id"))
        
        conn.commit()
    
    print("Tables dropped successfully!")
    print("Now run 'alembic upgrade head' to recreate the tables with the correct schema.")
